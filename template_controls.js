import * as cohoard from "https://static.witchoflight.com/~a2aaron/cohoard/v0.7.0/cohoard.js";
...
function load_builtin_templates() {
    let builtins = [DISCORD_BUILTIN, TWITTER_BUILTIN, HOMESTUCK_BUILTIN, FOOTBALL_BUILTIN, UNDERTALE_BUILTIN, WIKIPEDIA_BUILTIN, CHATGPT_BUILTIN, CORRU_BUILTIN];
...
export const CORRU_BUILTIN = await Template.builtin("corru.observer", "https://raw.githubusercontent.com/a2aaron/Cohoard/gh-pages/templates/corru_observer.html", "corru-observer");
